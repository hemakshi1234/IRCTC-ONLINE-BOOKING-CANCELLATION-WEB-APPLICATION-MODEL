  ...
  <div class="demo">
    <div class="login">
      ...
      <form name="loginForm" action="LoginController" method="post">
        ...
        <button type="button" class="login__submit" onClick="submitForm();">Sign in</button>
        
        <p class="login__signup">Developed by Hemakshi</p>
      </div>
    </div>
    </form>
    <div class="app">
      <div class="app__top">
        ...
        <div class="app__user">
          <img src="" alt="" class="app__user-photo" />
      ...
      <div class="app__bot">
        ...
        <div class="app__meetings">
          <div class="app__meeting">
            <img src="" alt="" class="app__meeting-photo" />
